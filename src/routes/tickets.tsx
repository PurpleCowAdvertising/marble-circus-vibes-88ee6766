  ...
  return (
    <PageGate keyName="page:tickets">
      ...
      <Section className="!pt-0 bg-black text-white">
        <VisibilityGate keyName="section:tickets.featured">
          <FadeIn>
        ...
        <VisibilityGate keyName="section:tickets.tiers">
          <FadeIn delay={0.15}>
        ...
        <VisibilityGate keyName="section:tickets.retailers">
          <FadeIn delay={0.25}>
        ...
        <VisibilityGate keyName="section:tickets.facts">
          <FadeIn delay={0.35}>
        ...
        <VisibilityGate keyName="section:tickets.disclaimer">
          <FadeIn delay={0.45}>

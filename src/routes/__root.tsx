...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Scorpion Kings — home of the artists, the events and the culture." },
      { name: "author", content: "Scorpion Kings" },
      { property: "og:title", content: "Scorpion Kings" },
      { property: "og:description", content: "Scorpion Kings — home of the artists, the events and the culture." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Scorpion Kings" },
      { name: "twitter:description", content: "Scorpion Kings — home of the artists, the events and the culture." },

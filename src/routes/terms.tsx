...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Use — Sony Music South Africa" },
      { name: "description", content: "Terms governing your use of the Sony Music South Africa website and related services." },
      { property: "og:title", content: "Terms of Use — Sony Music SA" },
...
const SECTIONS = [
  ...
  { h: "2. Use of content", p: "All content — including text, graphics, logos, images, audio and video — is owned by or licensed to Sony Music Entertainment Africa (Pty) Ltd and protected by copyright and other intellectual property laws. You may view and download content for personal, non-commercial use only." },
  ...
  { h: "4. Tickets & events", p: "Tickets purchased for any Sony Music SA event are subject to the terms and conditions of the ticketing partner and the event venue. Refund and exchange policies will be communicated at point of sale." },
  { h: "5. Disclaimer", p: "This website is provided on an \"as is\" basis. To the fullest extent permitted by law, Sony Music makes no warranties of any kind regarding the site or its content." },
  { h: "6. Limitation of liability", p: "Sony Music shall not be liable for any indirect, incidental or consequential damages arising from your use of this website, including but not limited to loss of data or profits." },

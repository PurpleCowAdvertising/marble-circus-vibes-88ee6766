          ...
          <FadeIn delay={0.2}>
            ...
            <ul className="mt-8 flex flex-wrap justify-center gap-4">
              {tierB.map((sponsor) => {
                ...
                const chipClassName = `flex h-20 w-[calc(50%-0.5rem)] items-center justify-center rounded-2xl border py-4 backdrop-blur-xl transition-colors sm:w-[calc(33.333%-0.75rem)] md:h-24 ${
                  isGautrain ? "lg:w-96 md:h-28" : "lg:w-64"
                } ${
                  sponsor.wide ? "px-3" : "px-6"
                } ${
                  sponsor.onLight ? "border-white/15 bg-white/90" : "border-white/10 bg-white/[0.06] hover:border-white/25"

...
export const SPONSORS: Sponsor[] = [
  ...
  { name: "Cabs Car Hire", logo: cabsCarHire.url, onLight: true, wide: true, url: "https://www.cabscarhire.co.za/", imgClassName: "h-full w-full object-contain object-center" },
];
